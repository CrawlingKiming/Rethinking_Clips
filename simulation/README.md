...
sweep, the decision study compares always-unclipped, always-clipped PPO, and a
gate that uses the unclipped update when sample ESS is at least 0.1 and PPO
