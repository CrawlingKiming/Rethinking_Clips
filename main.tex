...
\begin{wrapfigure}[18]{r}{0.44\textwidth}
  ...
  \centering
  \includegraphics[width=\linewidth]{figures/gaussian_is_mse.pdf}
  \caption{Exact IS gradient MSE as a function of ESS $\rho$ in the
  Gaussian bandit.}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{figures/gaussian_policy_comparison.pdf}
