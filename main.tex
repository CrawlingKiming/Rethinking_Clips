...
\begin{figure}[htbp]
  ...
  \includegraphics[width=\linewidth]{figures/gaussian_policy_comparison_compact.pdf}
...
\begin{figure}[htbp]
  ...
  \includegraphics[width=\linewidth]{figures_mains/motivation/ess_reliability_collapse_compact.pdf}
  \caption{
...
training dynamics. All three importance-weighted updates improve substantially during the early stage of training, but their performance eventually begins to degrade. At the onset of the sustained decline, all three methods exhibit low ESS. The right panel tests the theoretical prediction more directly. At each evaluation checkpoint, we pair the current ESS with the change in AIME-2024
...
\begin{wrapfigure}[26]{R}{0.45\textwidth}
  ...
  \caption{Top: Qwen3-1.7B results over extended training. AIME-2024 result is shown for GRPO (dashed) and TIS-3 + Clip (solid). The blue line represents ESS for TIS-3 + Clip. Bottom: RLHF on Qwen3-4B-Instruct-2507. End labels report the step-200 observations.}
