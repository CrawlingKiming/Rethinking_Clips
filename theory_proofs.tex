...
\subsection{Proof of Corollary~\ref{cor:finite-time-mse}}
...
\end{align}
Divide \eqref{eq:finite-time-proof-5} by $T$ to obtain
\eqref{eq:finite-time-mse}.  For a uniform independent index $U$,
\begin{align}
  \E\|\nabla J(\theta_U)\|_2^2
  &=\frac1T\sum_{t=0}^{T-1}\E\|g_t\|_2^2.
    \label{eq:finite-time-proof-6}
\end{align}
Taking expectation in \eqref{eq:finite-time-mse} gives the stated random-path
version.
\end{proof}
...
\begin{align}
  \E\|\nabla J(\theta_U)\|_2^2
  &\le\frac{2\{J^\star-J(\theta_0)\}}{\eta T}
    +\frac1T\sum_{t=0}^{T-1}
...
Corollary~\ref{cor:finite-time-mse}.  Equation
